...
from af001 (in Healey model)
Here instead of E, make Yo2:C output.
@author: Keisuke
'''
...
#    fn00=(1/z)/(1/y+1/z)        #The ration of electron used for nitrogen fixation
    ...
    Yo2C = S4a[0,3]/(n * (-S4a[1,8]))          #see "05 McCarty Matrix.xlsx"
    
    return(mcCarty(Yo2C,E))
